    ...
    <main className="article-container">
      <article className="article">
        ...
        <section className="article-section">
          ...
          <p>Generally, we see an issue with this argument with the concept of the infinite. We can consider something with the property of being greater than any other conceivable thing as analogous to a limit approaching infinity in mathematics. My understanding stretches only to basic introductory analysis, but in the standard case, <code>infinity + 1 {'>'} infinity</code> is not a statement we can confidently assert. In my opinion, this observation undermines a lot of the future argument, as we see that much of the argument relies on D, and D only holds true with the concept of God rather than being God itself. It's easier to argue about the concept of God and its existence in our understanding, rather than its actual existence in reality.</p>
          ...
          <p>I think that asserting that a being conceived to exist in reality makes the actual entity greater is logically inconsistent. Let’s define ‘greater than’ as meaning that a being with more attributes is greater than one without those attributes. Suppose we take H as true, then something that has the property of not being conceived to exist in reality is also an additional property. However, by H, God does not have this property, but it must have it in order to be consistent with A. This is a contradiction, as A and H cannot be mutually true.</p>

          <p>The core issue this argument runs into is treating an entity with the properties of the infinite identically to one that is finite in nature. The arguments that Anslem uses hold true for finite entities but not for infinite ones. The assumptions he presumes trivially true in the argument can be inverted and still be true – however, these two statements will contradict each other and obviously cannot coexist.</p>
